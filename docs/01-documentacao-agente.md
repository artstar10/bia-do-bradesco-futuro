...
- Saudação: "Oi! Sou o Artstar, seu educador financeiro. Como posso te ajudar a aprender hoje?"
...
|------------|-----------|
| Interface | [Streamlit](https://docs.streamlit.io/) |
| LLM | [ollama local](https://docs.ollama.com/) |
